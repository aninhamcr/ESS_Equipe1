...
And the reservation request has room "Lab 01", computer quantity "3", start time "10/04/2026 08:00", and end time "10/04/2026 10:00"
...
And the reservation request has room "Lab 02", computer quantity "2", start time "10/04/2026 14:00", and end time "10/04/2026 16:00"
When student "Vitoria" with CPF "12345678901" requests a computer reservation
...
And the reservation request has room "Lab 03", computer quantity "4", start time "10/04/2026 08:00", and end time "10/04/2026 10:00"
...
And the reservation request has room "Lab 04", computer quantity "1", start time "10/04/2026 09:00", and end time "10/04/2026 11:00"
When student "Vitoria" with CPF "12345678901" requests a computer reservation
Then the reservation request should be rejected
...
And the reservation update has room "Lab 06", computer quantity "4", start time "10/04/2026 09:00", and end time "10/04/2026 11:00"
...
And the reservation update has room "Lab 07", computer quantity "4", start time "10/04/2026 09:00", and end time "10/04/2026 11:00"
When student "Vitoria" with CPF "12345678901" requests to update that computer reservation
